...
<div class="panel panel-primary">
  <div class="panel-heading">
    ...
    echo $this->Html->link(
      'Add Student',
      ['controller'=>'Students','action'=>'addStudent'],
  ...
  <div class="panel-body">
    ...
    <table id="tbl-students-list" class="table table-bordered table-striped">
      ...
      <tbody>
        ...
        ?>
            <tr id="studentRec <?php echo $data->id; ?>">
              <td><?= $data->id ?></td>
              <td><?= $data->name ?></td>
              <td><?= $data->email ?></td>
              <td><?= $data->phone_no ?></td>
              <td>
                <a href="<?= $this->Url->build('http://localhost:8765/Students/editStudents/' . $data->id, ['fullBase' => true]) ?>" class="btn btn-warning">Edit</a>
