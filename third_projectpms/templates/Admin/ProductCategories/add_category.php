            ...
            <div class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column ms-auto me-auto ms-lg-auto me-lg-5">
              <div class="card card-plain">
                <div class="card-header">
                  ...
                  <p class="mb-0">Enter details to add a Category</p>
                </div>
                <div class="card-body">

                  <?php echo $this->Form->create($category,['id'=>'form','enctype'=>'multipart/form-data'])?>
                  <?php echo $this->Form->control('category_name',['required'=>false,'class'=>'form-control mb-3','label'=>['class'=>'form-label']])?>
                  <?= $this->Form->button(__('Add Category'),['class'=>'btn btn-lg bg-gradient-primary btn-lg w-100 mt-4 mb-0']) ?>
